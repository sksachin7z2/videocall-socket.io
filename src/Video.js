...
class Video extends Component {
	...
	render() {
		...
		return (
			<div style={{height:"100vh",background:"#0c111f"}} className=''>
				{this.state.askForUsername === true ?
					<div>
						<div >
							<p style={{fontSize:"1.5rem", padding: '2rem  0' ,color:"white", fontWeight: "bold", paddingRight: "50px" }}>Set your username</p>
							<Input style={{color:"white",border:"2px solid gray", borderRadius:"5px", padding:"5px"}} placeholder="Username" value={this.state.username} onChange={e => this.handleUsername(e)} />
							<Button variant="contained" color="primary" onClick={this.connect} style={{ margin: "20px" }}>Connect</Button>
						</div>

						<div style={{ justifyContent: "center", textAlign: "center", paddingTop: "40px" }}>
							<video id="my-video" ref={this.localVideoref} autoPlay muted style={{
								borderStyle: "solid",borderColor: "#bdbdbd",objectFit: "fill",width: "40vw",height: "50vh"}}></video>
						</div>
					</div>
					:
					<div>
